    ...
    <section className="px-5 xl:px-0">
      <div className='max-w-[1170px] mx-auto'>
        <div className='grid grid-cols-1 lg:grid-cols-2'>
          {/*=====img box=====*/}
          <div className="hidden lg:block bg-primaryColor rounded-l-lg bg-primaryColor rounded-l-lg">
        ...
        <div className='rounded-l-lg lg:pl-16 py-10'>
          ...
          <div className='mb-5 flex items-center gap-3'>
                ...
                <div className='relative'>
                  ...
                  />
                  <label htmlFor='customFile' className='text-primaryColor cursor-pointer'>Upload photo</label>
                </div>
              </div>

              <div className="mt-7">
          <button disabled={loading && true} type="submit" className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3">{ loading ? (<HashLoader size={35} color="#ffffff"/>
          ) : (
            'SignUp'
          )}</button>
        </div>
