...

    {
      ...
      <div className='md:col-span-2 md:px-[30px]'>
        ...
        <button 
          ...
          className={`p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor ${tab === 'bookings' ? 'bg-primaryColor text-white font-normal' : ''}`}>
          My Bookings
        </button>
        <button 
